...
{
    public interface ICategoryRepository : IRepository<Category>, IAsyncRepository<Category>    // Ne için çalışıyorsa onu veriyoruz. Burada <Category> Yani IRepository'de bulunan <T> => <Category> olacak şekilde oluşmuş oldu.
    {
