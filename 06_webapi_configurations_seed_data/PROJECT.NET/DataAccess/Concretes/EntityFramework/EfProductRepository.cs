...
namespace DataAccess.Concretes.EntityFramework
{
    public class EfProductRepository : IProductRepository
    {
        ...
        public void Delete(Product product)     // INMEMORY'DE SİLME İŞLEMLERİ FARKLI REFERANS İŞLEMLERİ GEREKTİREBİLİRDİ. ENTITYFRAMEWORK İÇİN BU ŞEKİLDE Delete işlemlerini gerçekleştiriyoruz
        {
