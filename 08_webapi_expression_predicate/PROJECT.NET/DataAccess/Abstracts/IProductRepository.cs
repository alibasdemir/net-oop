...
{
    public interface IProductRepository : IRepository<Product>     // Ne için çalışıyorsa onu veriyoruz. Burada <Product> Yani IRepository'de bulunan <T> => <Product> olacak şekilde oluşmuş oldu.
    {
