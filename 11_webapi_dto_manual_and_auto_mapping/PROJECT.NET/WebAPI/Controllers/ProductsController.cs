...
namespace WebAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase    // ControllerBase'den türer.
    {
       ...
       // IProductService productService = new ProductManager();  // NEW'LEMEK YANLIŞ BUNUN YERİNE DI YANİ DEPENDENCY INJECTION KULLANIRIZ. 
        ...
        public async Task<List<ListProductResponse>> GetAll()      // DTO --->> Ürün listelenirken Product yerine ProductForListingDto yazdık
        {
            return await _productService.GetAll();
        }

        [HttpPost]
        public async Task Add([FromBody] AddProductRequest product)   // async yaptık ve Task yazdık. --->> DTO -> ARTIK KULLANICADAN İSTEYECEĞİMİZ BİLGİLERİ İÇEREN DTO'yu yazdık "ProductForAddDto"
        {
